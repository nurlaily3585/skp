                    ...
                    <tbody>
                        ...
                        <?php foreach ($kegiatan as $k) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($k['status'] == 1) : ?>
                                        <a href="<?= base_url('kaprodi/v_ikuti'); ?>" class="btn btn-primary btn-icon-split">
                                    ...
                                    <?php elseif ($k['tgl_kegiatan'] == time()) : ?>
                                        <a href="<?= base_url('kaprodi/v_ikuti/'); ?><?= $k['id_kegiatan']; ?>" class="btn btn-primary btn-icon-split">
                                            <span class="icon text-white-50">
                                                <i class="fas fa-check"></i>
                                            </span>
                                            <span class="text">Ikuti</span>
