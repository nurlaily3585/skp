...
class Dosen extends CI_Controller
{
    ...
    public function index()
    {
        ...
        // Untuk data grafik
        $data['hasil'] = $this->m_dosen->Jum_mahasiswa_perjurusan();
    ...
    public function v_riwayat()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('dosen/v_riwayat', $data);
        $this->load->view('templates/footer');
    }
    public function v_list()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('dosen/v_list', $data);
        $this->load->view('templates/footer');
    }
    public function v_add()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('dosen/v_add', $data);
        $this->load->view('templates/footer');
    }
    public function v_ikuti()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('dosen/v_ikuti', $data);
        $this->load->view('templates/footer');
    }
}
